...
*/
  ...
  q("Promise", function (a) {
    ...
    b.race = function (g) {
      return new b(function (h, k) {
        for (var m = n(g), p = m.next(); !p.done; p = m.next())
          d(p.value).G(h, k);
      });
    };
    b.all = function (g) {
      ...
      if (p && t(h.b, m))
        for (h = 0; h < p.length; h++) {
          ...
          if ((k !== k && x.key !== x.key) || k === x.key)
            return { id: m, list: p, index: h, l: x };
        }
  ...
  function Fa(a) {
    return a instanceof G && a.constructor === G && a.b === Ea
      ? a.a
      : "type_error:Const";
  }
  function H(a) {
  ...
  function Pa(a) {
    return a instanceof K && a.constructor === K && a.b === Oa
      ? a.a
...
*/
  ...
  function $b(a) {
    ...
    for (var d = (c = !1); a.h.length && !a.j; ) {
      ...
      if ((f = a.g ? g : f))
        try {
          ...
          void 0 !== h &&
            ((a.g = a.g && (h == b || h instanceof Error)), (a.c = b = h));
          if (
            Kb(b) ||
    ...
    d &&
      ((h = C(a.B, a, !0)),
      (d = C(a.B, a, !1)),
      b instanceof Q ? (bc(b, h, d), (b.U = !0)) : b.then(h, d));
  ...
  l.D = function (a) {
    ...
    var b = [];
    if ("string" === typeof a)
      Lc(this, a) && (b = Ja(b, this.a.get(W(this, a))));
    else {
      a = this.a.D();
  ...
  function Pc() {
    ...
    Nc = Z = Mc = null;
    y("google.load") ||
      (D("google.load", Qc), D("google.setOnLoadCallback", J.R));
